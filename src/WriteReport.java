...
public class WriteReport extends Thread{
    private static final double totalRevenue = calculate.getTotalRevenue();
    private static final double totalProfit = calculate.getTotalProfit();
    private static Map<String, Double> totalPricePerShirtSize = calculate.getProfitPerShirtSizeMap();
    private String reportName;

    public WriteReport(String reportName) {
    ...
    private static void generateReport(String reportName, String content) {
        try {
            FileWriter writer = new FileWriter(reportName + "_report.csv");
